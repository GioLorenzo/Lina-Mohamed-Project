...
var headline = document.querySelectorAll('.up');
var nav = document.querySelector('.nav');
var subName = document.querySelector('.sub-name');
var bottomLText = document.querySelector('.bottom-l-text span');
var spans = document.querySelectorAll(".span-wrap span");
...
var navLinksUp = function navLinksUp() {
  nav.style.transition = 'transform 1000ms ease';
  nav.style.transform = 'translateY(0)';
};

var headlineUp = function headlineUp() {
  headline.forEach(function (span) {
    span.style.transition = 'transform 1000ms ease';
    span.style.transform = 'translate(0, 0)';
  });
};

var subNameUp = function subNameUp() {
  subName.style.transition = 'transform 1000ms ease';
  subName.style.transform = 'translate(0, 0)';
};

var spansUp = function spansUp() {
  spans.forEach(function (x, i) {
    setTimeout(function () {
...
var headline1 = Array.prototype.slice.call(document.getElementsByTagName('span'));
outputLayers.then(function () {
  return headline1.map(function (span) {
    setTimeout(function () {
